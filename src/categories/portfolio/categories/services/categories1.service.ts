...
import { PortfolioCategory1 } from 'src/common/entities/category.model';
...
@Injectable()
export class PortfolioCategory1Service {
  constructor(
    @InjectModel(PortfolioCategory1.name, 'portfolioDB')
